  ...
  if(in_array($fileActualExt, $allowed)) {
    if($fileError=== 0) {
      if($fileSize < 100000000000) {
        ...
        mkdir("./uploads/" .$fileName. "Folder");
        $f = "./uploads/" .$fileName.".enc.enc" ;
        $fold = "./uploads/" .$fileName. "Folder" ;
        
        $my_command1 = escapeshellcmd("python C:/xampp/htdocs/secure/sm.py ".$f. " ".$fold);
